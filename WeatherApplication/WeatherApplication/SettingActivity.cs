...
namespace WeatherApplication
{
    ...
    public class SettingActivity : PreferenceActivity
    {
        ...
        private void DisplaySummary()
        {
            ...
            //cityPref.Title += sharedPref.GetString(cityPref.Key, GetString(Resource.String.default_city));
            ...
            var lang = AppHelper.sharedPref.GetString(langPref.Key, GetString(Resource.String.default_unit));
